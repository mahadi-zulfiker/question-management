      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10">
          ...
          <div className="bg-white p-8 rounded-lg shadow-md hover:shadow-xl transition duration-300">
            ...
            <h3 className="text-xl font-semibold text-gray-700 mb-4">সহজ ব্যবস্থাপনা</h3>
          ...
          <div className="bg-white p-8 rounded-lg shadow-md hover:shadow-xl transition duration-300">
            ...
            <h3 className="text-xl font-semibold text-gray-700 mb-4">বিস্তৃত গাইড</h3>
            <p className="text-gray-600 leading-relaxed">
          ...
          <div className="bg-white p-8 rounded-lg shadow-md hover:shadow-xl transition duration-300">
            ...
            <h3 className="text-xl font-semibold text-gray-700 mb-4">নিরাপদ ও নির্ভরযোগ্য</h3>
            <p className="text-gray-600 leading-relaxed">
          ...
          <div className="bg-white p-8 rounded-lg shadow-md hover:shadow-xl transition duration-300">
            ...
            <h3 className="text-xl font-semibold text-gray-700 mb-4">রিয়েল-টাইম আপডেট</h3>
            <p className="text-gray-600 leading-relaxed">
