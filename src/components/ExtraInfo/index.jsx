...
function ExtraInfo() {
  return (
    <div className="bg-white shadow-lg rounded-lg p-6 mb-8 max-w-6xl mx-auto my-16">
      <h2 className="text-2xl font-bold text-gray-800 mb-4 text-center border-b-2 border-blue-500 pb-2">
        অতিরিক্ত তথ্য
      </h2>
      <div className="flex flex-col md:flex-row items-center justify-between gap-6">
        ...
        <div className="flex-1 space-y-4">
          <div className="flex items-center gap-4">
            <span className="text-3xl font-bold text-blue-500 bg-blue-100 p-2 rounded-full w-12 h-12 flex items-center justify-center">
              ১
            </span>
        ...
        <div className="flex-1">
          <div className="bg-blue-50 rounded-lg p-4 border border-blue-200 shadow-md">
