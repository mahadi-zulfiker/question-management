...
export default function CreateCQTeacher() {
  ...
  const [cqs, setCQs] = useState([
    {
      passage: initialSlateValue, // For generalCQ
      questions: [initialSlateValue, initialSlateValue, initialSlateValue, initialSlateValue], // For generalCQ
      answers: [initialSlateValue, initialSlateValue, initialSlateValue, initialSlateValue], // For generalCQ
      latexPassage: "", // For mathCQ
      latexQuestions: ["", "", ""], // For mathCQ
      latexAnswers: ["", "", ""], // For mathCQ
      image: null,
  ...
  const downloadExcelTemplate = () => {
    const templateData = [
      ...
      },
      {
        ...
        "Knowledge Question": "What is the sum of \\frac{1}{2} and \\frac{1}{3}?",
        "Knowledge Answer": "\\frac{5}{6}",
        "Comprehension Question": "",
        "Comprehension Answer": "",
        "Application Question": "If x = \\frac{1}{2}, compute x + \\frac{1}{3}.",
        "Application Answer": "\\frac{5}{6}",
        "Higher Skills Question": "Prove that \\frac{1}{2} + \\frac{1}{3} = \\frac{5}{6}.",
        "Higher Skills Answer": "Using common denominator: \\frac{3}{6} + \\frac{2}{6} = \\frac{5}{6}.",
        "Image Alignment": "center",
        "Video Link": "",
      },
    ];
                ...
                >
                  ...
                  {cqType === "generalCQ" ? (
                    ...
                    <EditableMathField
                      ...
                      className="border p-3 rounded-lg w-full text-lg shadow-sm bangla-text"
                    />
                  )}
              ...
              >
                ...
                {cqType === "generalCQ" ? (
                  ...
                  <StaticMathField className="text-gray-700 mb-4 bangla-text">
                    {cq.latexPassage || "গাণিতিক উদ্দীপক লিখুন"}
                  </StaticMathField>
                )}
